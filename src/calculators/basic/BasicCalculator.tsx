    ...
    return (
        <div className="max-w-md mx-auto">
            <div className="bg-white p-6 rounded-3xl shadow-xl border border-slate-100">
                {/* Display */}
                <div className="mb-6 bg-slate-50 p-4 rounded-2xl text-right border border-slate-100 overflow-hidden">
                    <div className="text-slate-500 text-sm h-6 font-medium tracking-wide">{equation}</div>
                    <div className="text-4xl font-bold text-slate-900 tracking-tight overflow-x-auto no-scrollbar whitespace-nowrap">
                        {display}
                    </div>
                </div>
                ...
                <div className="grid grid-cols-4 gap-3">
                    <button onClick={clear} className={cn(btnClass, actionBtn, "col-span-2 text-red-500")}>
                        AC
                    </button>
                    ...
                    <button
                        onClick={calculate}
                        className={cn(btnClass, "bg-blue-600 text-white hover:bg-blue-700 border-transparent shadow-blue-200 shadow-lg")}
                    >
                        <Equal size={28} />
                    </button>
                </div>
