...
export default function BMIContent() {
    return (
        <div className="prose prose-slate max-w-none mt-12 text-left">
            ...
            <h3>BMI Ranges & Health Categories</h3>
            <p>
            ...
            <div className="overflow-x-auto my-6">
                <table className="w-full text-sm text-left border-collapse">
                    <thead className="text-xs text-slate-700 uppercase bg-slate-100">
                        <tr>
                            <th className="px-6 py-3 border border-slate-200">BMI Range (kg/m²)</th>
                            <th className="px-6 py-3 border border-slate-200">Weight Status</th>
                            <th className="px-6 py-3 border border-slate-200">Health Risk</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr className="bg-white border-b border-slate-200">
                            ...
                            <td className="px-6 py-4">Moderate (Nutritional deficiency)</td>
                        </tr>
                        <tr className="bg-white border-b border-slate-200">
                            <td className="px-6 py-4 font-medium">18.5 – 24.9</td>
                            <td className="px-6 py-4 text-green-600 font-semibold">Normal Weight</td>
                            <td className="px-6 py-4">Low Risk</td>
                        </tr>
                        <tr className="bg-white border-b border-slate-200">
                            <td className="px-6 py-4 font-medium">25.0 – 29.9</td>
                            <td className="px-6 py-4 text-yellow-600 font-semibold">Overweight</td>
                            <td className="px-6 py-4">Increased</td>
                        </tr>
                        <tr className="bg-white border-b border-slate-200">
                            <td className="px-6 py-4 font-medium">30.0 – 34.9</td>
                            <td className="px-6 py-4 text-orange-600 font-semibold">Obesity Class I</td>
                            <td className="px-6 py-4">High</td>
                        </tr>
                        <tr className="bg-white border-slate-200">
                            <td className="px-6 py-4 font-medium">35.0 and Above</td>
                            <td className="px-6 py-4 text-red-600 font-semibold">Obesity Class II/III</td>
            ...
            <div className="grid md:grid-cols-2 gap-8 my-8">
                <div>
                    <h4 className="text-red-700 font-bold mb-2">Risks of Being Overweight</h4>
                ...
                <div>
                    <h4 className="text-blue-700 font-bold mb-2">Risks of Being Underweight</h4>
                    <ul className="list-disc pl-5 space-y-1 text-slate-600">
            ...
            <div className="grid md:grid-cols-2 gap-4 my-4">
                <div className="bg-slate-50 p-4 rounded-lg border border-slate-200">
                    <p className="font-bold text-slate-700 text-center mb-2">Metric System</p>
                    <p className="font-mono text-center text-lg">BMI = weight (kg) / height² (m)</p>
                </div>
                <div className="bg-slate-50 p-4 rounded-lg border border-slate-200">
                    <p className="font-bold text-slate-700 text-center mb-2">Imperial System</p>
                    <p className="font-mono text-center text-lg">BMI = 703 × weight (lbs) / height² (in)</p>
                </div>
            </div>
            ...
            <div className="bg-green-50 p-6 rounded-xl border border-green-100 my-8">
                <h3 className="text-green-900 mt-0">Steps to Maintain Optimum Health</h3>
