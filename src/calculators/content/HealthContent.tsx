...
export default function HealthContent({ calculatorId }: { calculatorId?: string; calculatorName?: string }) {
    ...
    return (
        <article className="prose prose-slate max-w-none">
            {specificIntro && (
                <div className="mb-10 p-6 bg-pink-50 rounded-2xl border border-pink-100 not-prose">
            ...
            <h3>Key Health Metrics Explained</h3>
            ...
            <p>To lose weight, you generally need to eat below your TDEE calculated limit.</p>
            ...
            <div className="bg-red-50 border-l-4 border-red-500 p-4 my-8">
                <p className="text-red-700 font-bold mb-1">Medical Disclaimer</p>
            ...
            <div className="space-y-4">
                <details className="group p-4 bg-white rounded-lg border border-slate-200 open:ring-1 open:ring-pink-500">
