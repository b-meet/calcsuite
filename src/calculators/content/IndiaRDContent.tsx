        ...
        <div className="space-y-12">
            <section>
                ...
                <div className="bg-green-50 dark:bg-green-900/30 p-6 rounded-2xl border border-green-100 dark:border-green-800">
                    <h3 className="flex items-center gap-2 text-lg font-semibold text-green-900 dark:text-green-100 mb-3">
                        <PiggyBank className="w-5 h-5" />
                        Ideal for Short-Term Goals
                    </h3>
                    <p className="text-green-800 dark:text-green-100 mb-3">
                        RDs are perfect for planned expenses occurring in 1-3 years:
                    </p>
                    <ul className="list-disc pl-5 space-y-2 text-green-800 dark:text-green-100">
            ...
            <section className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-100 dark:border-slate-800">
                <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4">RD vs SIP: Which is better?</h3>
