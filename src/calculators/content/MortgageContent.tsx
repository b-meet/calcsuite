...
export default function MortgageContent() {
    return (
        <div className="prose prose-slate dark:prose-invert max-w-none mt-12 text-left">
            <h2 className="text-slate-900 dark:text-white">Mortgage Calculator Guide</h2>
            ...
            <h3 className="text-slate-900 dark:text-white">Mortgages</h3>
            <p className="text-slate-600 dark:text-slate-200">
            ...
            <h3 className="text-slate-900 dark:text-white">Mortgage Calculator Components</h3>
            <p className="text-slate-600 dark:text-slate-200">A mortgage usually includes the following key components. These are also the basic components of a mortgage calculator.</p>
            ...
            <h3 className="text-slate-900 dark:text-white">Costs Associated with Home Ownership and Mortgages</h3>
            <p className="text-slate-600 dark:text-slate-200">
            ...
            <h4 className="text-slate-900 dark:text-white">Recurring Costs</h4>
            <ul className="text-slate-700 dark:text-slate-300">
            ...
            <h4 className="text-slate-900 dark:text-white">Non-Recurring Costs</h4>
            <ul className="text-slate-700 dark:text-slate-300">
            ...
            <h3 className="text-slate-900 dark:text-white">Early Repayment and Extra Payments</h3>
            <p className="text-slate-600 dark:text-slate-200">
            ...
            <h4 className="text-slate-900 dark:text-white">Early Repayment Strategies</h4>
            <ul className="text-slate-700 dark:text-slate-300">
            ...
            <h3 className="text-slate-900 dark:text-white">Brief History of Mortgages in the U.S.</h3>
            <p className="text-slate-600 dark:text-slate-200">
