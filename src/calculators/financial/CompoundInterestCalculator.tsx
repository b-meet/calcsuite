...
import { IndianRupee, DollarSign, TrendingUp, Calendar, Coins } from 'lucide-react';
import {
    Chart as ChartJS,
    ArcElement,
    Tooltip,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-2 pt-2">
                            ...
                            />
                            <label htmlFor="contrib" className="text-sm font-medium text-slate-700">Add Regular Contributions</label>
                        </div>

                        {withContribution && (
                            <div className="p-4 bg-slate-50 rounded-lg space-y-4 border border-slate-200 animate-in fade-in slide-in-from-top-2">
                                <div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select
                                            ...
                                            className="block w-full px-4 py-2 border border-slate-200 rounded-lg"
                                        >
            ...
            <div className="space-y-6">
                <div className="bg-slate-900 text-white p-6 rounded-2xl shadow-lg">
                    <h3 className="text-lg font-medium text-slate-300 mb-6">Projection</h3>
                    <div className="space-y-6">
                        <div>
                        ...
                        <div className="grid grid-cols-2 gap-8 pt-6 border-t border-slate-800">
                            <div>
                                <p className="text-slate-400 text-sm mb-1">Total Principal</p>
                        ...
                        <tbody className="divide-y divide-slate-100">
                            {result.breakdown.map((row) => (
                                <tr key={row.year} className="hover:bg-slate-50">
                                    ...
                                    <td className="px-6 py-3">{new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(row.startBalance)}</td>
                                    <td className="px-6 py-3">{new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(row.deposits)}</td>
                                    <td className="px-6 py-3 text-green-600">+{new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(row.interest)}</td>
                                    <td className="px-6 py-3 font-semibold">{new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(row.endBalance)}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
