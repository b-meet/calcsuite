                ...
                <div className="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <input
                            ...
                            className="block w-full px-4 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500 text-lg"
                        />
                    </div>
                    <div>
                    ...
                    {original === 0 ? (
                        ...
                        <>
                            <div className="flex items-center justify-center gap-2 mb-2">
                                {result?.type === 'increase' && <ArrowUpRight className="w-6 h-6 text-green-600" />}
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm max-w-sm mx-auto">
                                ...
                                <div className="bg-white/50 p-3 rounded-lg">
                                    <p className="text-slate-500 mb-1">% of Original</p>
                                    <p className="font-semibold text-slate-900">
                            ...
                            <p className="text-slate-500 mt-6 text-sm">
                                The value went from <strong>{original}</strong> to <strong>{newValue}</strong>.
                            </p>
                        </>
                    )}
                </div>
