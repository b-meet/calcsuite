...
export function TickerHub() {
    ...
    return (
        <div className="w-full bg-white/50 dark:bg-slate-900/50 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 h-10 overflow-hidden relative ticker-mask pause-on-hover">
            <div className="absolute inset-y-0 left-0 w-max flex items-center animate-ticker" style={{ '--ticker-duration': '40s' } as React.CSSProperties}>
                {items.map((link, idx) => {
