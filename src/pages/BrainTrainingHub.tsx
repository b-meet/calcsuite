    ...
    return (
        <div className="min-h-screen bg-[#020617] text-slate-200 py-8 px-4 sm:px-8">
            ...
            <div className="max-w-5xl mx-auto space-y-12">
                {/* Hero Header */}
                <header className="relative p-8 rounded-[32px] bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 shadow-2xl overflow-hidden group">
                    ...
                    <div className="relative flex flex-col md:flex-row items-center justify-between gap-8">
                        <div>
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-blue-400/80 font-bold text-xs tracking-widest uppercase">Competitive Training</p>
                                </div>
                            </div>
                        ...
                        {/* Streak Card */}
                        <div className="flex flex-col items-center justify-center px-8 py-5 rounded-2xl bg-slate-800/40 border border-slate-700/50 backdrop-blur-md">
                            <div className="flex items-center gap-2 mb-1">
                                <Zap size={14} className="text-blue-400 fill-blue-400 animate-pulse" />
                                <span className="text-[10px] font-black uppercase text-slate-500 tracking-[0.15em]">Current Streak</span>
                            </div>
                ...
                <section className="space-y-8">
                    <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                        <h2 className="text-lg font-black uppercase italic tracking-wider text-white flex items-center gap-3">
                            <TrendingUp className="text-blue-500" size={18} />
                            Available Challenges
                        </h2>
                        <span className="px-3 py-1 bg-slate-800 rounded-full text-[10px] font-bold text-slate-400 border border-slate-700">no login</span>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-20">
                        {/* Daily KenKen Card - Reverted to Grid with Hover Reveal */}
                        <div className="group relative flex flex-col p-8 rounded-[32px] bg-slate-900 border-2 border-slate-800 hover:border-blue-500/30 transition-all duration-500 overflow-hidden shadow-xl min-h-[380px]">
                            {/* Glow */}
                            ...
                            <div className="flex justify-between items-start mb-6">
                                ...
                                <div className="flex flex-col items-end gap-1">
                                    <span className="text-[10px] font-black text-blue-500 tracking-widest">DAILY PUZZLE</span>
                                    <div className="flex items-center gap-1.5 px-2.5 py-0.5 bg-blue-500/10 border border-blue-500/20 rounded-lg text-blue-400">
                            ...
                            <h3 className="text-2xl font-black text-white mb-2 italic uppercase tracking-tight">Daily KenKen</h3>
                            <p className="text-sm text-slate-400 leading-relaxed mb-6">The ultimate arithmetic logic puzzle. Fill the grid using math cages — no number can repeat in any row or column.</p>

                            {/* How to Play Button */}
                            <button
                                onClick={() => setShowHelp(true)}
                                className="flex items-center gap-2 text-xs text-blue-400 hover:text-blue-300 font-bold mb-8 w-fit group/help transition-colors"
                            >
                                <TrendingUp size={16} className="text-blue-500 group-hover/help:translate-x-1 transition-transform" />
                            ...
                            <div className="mt-auto space-y-4">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="text-[10px] font-bold text-slate-300 uppercase tracking-widest italic opacity-50">
                                        Select Level
                                    </div>
                                </div>
                        ...
                        <div className="relative flex flex-col p-8 rounded-[32px] bg-slate-950/50 border-2 border-slate-900 overflow-hidden group/soon min-h-[380px] grayscale">
                            ...
                            <div className="relative flex justify-between items-start mb-6">
                                ...
                                <div className="px-3 py-1 bg-slate-900 rounded-full border border-slate-800 text-[9px] font-black text-slate-700 uppercase tracking-widest">
                                    <Lock size={10} className="inline mr-1" />
                                    Coming Soon
                                </div>
                            </div>
                            <div className="relative">
                                <h3 className="text-2xl font-black text-slate-700 mb-2 italic uppercase tracking-tight">Speed Math</h3>
                                <p className="text-sm text-slate-800 leading-relaxed mb-8 italic">Race against the clock in a mental sprint. Complete operations in under 60, 120 or 180 seconds.</p>
                            </div>
                            <div className="relative mt-auto pt-6 border-t border-slate-900/50 flex justify-between items-center text-[9px] font-black uppercase tracking-widest text-slate-800 italic">
                                <span>Complexity: High</span>
                                <span>Season 2 Content</span>
                            </div>
                        </div>
                    </div>
