...
const About = () => {
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 py-8 px-2 sm:px-4 lg:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-16">
                    <div className="bg-white dark:bg-slate-800 p-4 sm:p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700">
